...
def main():
    for f_i in range(n_fold):
        output_data_dir = f'/home/swang/xuhw/research-projects/data/Pisces/xenograft_data_10fold/best_response/fold{f_i}'
