...
def main():
    ...
    data_dir = f"/mnt/hanoverdev/scratch/hanwen/data/Pisces/ddi1000_50_ddi_types/"
    save_dir = f"/mnt/hanoverdev/scratch/hanwen/data/Pisces/ddi1000_50_ddi_types/"
    drug_smiles_dir = "{}{}".format(data_dir, 'drug_smiles.txt')
    
    identified_y2ddi_type = collections.OrderedDict()
    identified_ddi_path = '/home/swang/xuhw/research-projects/Pisces/Pisces/scripts/case_study/ddi_network_50_ddi_types/output/identified_ddi.txt'
    idx = 0
    ...
    train_csv_file = "{}{}".format(data_dir, 'data_50_ddi_types.csv')
    valid_csv_file = "{}{}".format(data_dir, 'data_50_ddi_types.csv')
