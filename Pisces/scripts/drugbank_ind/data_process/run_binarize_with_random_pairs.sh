...
DATADIR=/home/swang/xuhw/research-projects/data/Pisces/drugbank_ind/fold$1
...
python fairseq_cli/preprocess.py \
    --only-source \
    --trainpref $DATADIR/train.randompair \
    --validpref $DATADIR/valid.randompair \
    --destdir $DATADIR/data-bin/randompair/ \
