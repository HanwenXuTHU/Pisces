...
LOADDIR=/mnt/hanoverdev/scratch/hanwen/exp/Pisces/multi_modal_drugbank_ind/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/pisces-mask-linear-topk$TOPK-lr$LR-norm-drop$DROP-memory$MEMORY-alpha$CONS_ALPHA-scsalpha$SCS_ALPHA-v2.9-noSMcons-raw
SAVEDIR=/mnt/hanoverdev/scratch/hanwen/exp/Pisces/multi_modal_drugbank_ind/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/pisces-mask-linear-topk$TOPK-lr$LR-norm-drop$DROP-memory$MEMORY-alpha$CONS_ALPHA-scsalpha$SCS_ALPHA-v2.9-noSMcons-raw
