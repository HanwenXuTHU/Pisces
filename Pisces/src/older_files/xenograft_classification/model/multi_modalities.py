...
class Pisces_MM_Model(BaseFairseqModel):
    ...
    def forward(self,
        ...
        if self.dual_view_encoder is not None:
            ...
            x = self.classification_heads[classification_head_name](seq_enc_a, seq_enc_b, model_input, labels)
...
@register_model_architecture("pisces_multi_modalities", "pisces_tiny")
def base_architecture(args):
