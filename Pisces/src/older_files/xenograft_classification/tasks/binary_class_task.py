...
class BinaryClassTask(FairseqTask):
    ...
    def __init__(self, cfg: BinaryClassConfig, data_dictionary, label_dictionary, model_dictionary, drug_id_dictionary):
        super().__init__(cfg)
    ...
    def setup_task(cls, cfg: BinaryClassConfig, **kwargs):
        ...
        return cls(cfg, data_dict, label_dict, model_dict, drug_id_dict)
